...
export function handleCommand(
  ...
  if (command.type === "InteractionCommand") {
    ...
    return { ...base, eventId: commandEventId(correlationId, "InteractionRequested"), type: "InteractionRequested", payload: { verb: command.verb, object, instrument: command.instrument?.raw ?? null, location: null, modifiers: [] } };
  }
