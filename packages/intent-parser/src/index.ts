...
export { splitReplicaClauses, classifyReplicaClauses } from "./replica-clauses.js";
export type { ReplicaActionClause, ReplicaInquiryClause, ReplicaClauseClassification } from "./replica-clauses.js";
