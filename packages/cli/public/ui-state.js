 ...
 * the input, send, retry and voice controls.
 *
 * Single owner: only setComposerState (composer-state.js) may call this
 * function. Shell/loading presentation (game-shell-view setShellBusy) must
 * not toggle composer controls — the two used to run back-to-back in one
 * submit lifecycle and agree only by coincidence.
 */
