...
const model: BeliefModel = { schemaVersion: 1, observerId: "player", beliefs: new Map(), activeHypotheses: [], knownRelations: [{ sourceId: "ridge", targetId: "river", type: "feeds", observedStrength: 0.6, confidence: 0.8, trend: "stable", discoveredAt: 1, evidenceIds: ["e-1"] }], contradictions: [], lastUpdated: 1 };
