...
const model: BeliefModel = { schemaVersion: 1, observerId: "player", beliefs: new Map([[
  "ridge", { patternId: "ridge", currentInterpretation: "A ridge persists", confidence: 0.7, supportingEvidence: [{ id: "e-1", type: "sensory", description: "A ridge", strength: 0.7, observedAt: 1, linkedObservationIds: [] }], openHypotheses: [], lastObserved: 1 },
