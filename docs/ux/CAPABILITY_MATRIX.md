...
|---|---|---|---|
| UX-001 | Directional movement via free-text intent | Current | Existing command/API; no direction buttons |
...
| UX-007 | Responsive playable shell | Current | UX-5.0 visual shell |
| UX-008 | Loading/reconnect/error states | Current | Client state contract |
| UX-009 | Trace/Hypothesis/Discovery views | Current | Discovery and Belief read models |
| UX-010 | Character identity onboarding | Current | UX-4.1 setup flow |
| UX-011 | Natural-language intents | Current (scoped) | Open intent parser; clarification remains incremental |
...
| UX-015 | Multiple characters/worlds | Current (worlds) | UX-4.0 persistence; multiple characters deferred |
...
| UX-021 | Observation & Belief Knowledge UI | Current | Normative BeliefModelDTO and ObservationAPI contract |
