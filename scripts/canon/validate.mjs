...
// Checks, fail-fast via exit code 1:
...
console.log(`[canon:validate] PASS (${concepts.size} concepts, ${anchors.length} anchors, ${claims.length} not-simulated claims, ${warnings.length} warning(s))`);
